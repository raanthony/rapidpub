...
$statement = $db->prepare("SELECT * FROM couleurs ORDER BY nom ASC LIMIT 20");
$statement->execute();
...
<link rel="stylesheet" href="./css/banderoles.css?<?php echo mt_rand(); ?>" type="text/css" media="all" />
...
<div id="banderoles_config">
	<div class="container-left">
		<div id="block_left">
			<div id="text_content">
				<div class="img">
					<img src="http://placehold.it/130x130" alt="Créer banderole en ligne" title="Produit préféré de nos clients" />
				</div>
				<div class="text">
					<h1>Banderoles</h1>
			...
			<div id="apercu_content">
				<div id="banderole_bg">
					<div id="banderole_content">
						...
						<div id="banderole_width"></div><div id="banderole_height"></div>
					</div>
				</div>
			</div>
		</div>
...
<script src="./js/banderoles.js?<?php echo mt_rand(); ?>"></script>
