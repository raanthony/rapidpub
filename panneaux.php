...
<link rel="stylesheet" href="./css/panneaux.css?<?php echo mt_rand(); ?>" type="text/css" media="all" />
...
<div id="panneaux_config">
	<div class="container-left">
		<div id="block_left">
			<div id="text_content">
				<div class="img">
					<img src="http://placehold.it/130x130" alt="Créer un panneau en ligne" title="Produit préféré de nos clients" />
				</div>
				<div class="text">
					<h1>Panneaux</h1>
			...
			<div id="apercu_content">
				<div id="panneau_bg">
					<div id="panneau_content">
						<div id="panneau_width"></div><div id="panneau_height"></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div id="config_right">
				<div id="dimensions">
					...
					<div id="longueur_cfg" style="position:relative">
						...
						<input type="text" maxlength="5" id="longueur" placeholder="longueur" class="dimensions_panneau" />
					</div>
					<div id="hauteur_cfg" style="position:relative;margin-left: 10px;">
						<img src="./img/hauteur.png" class="dim_img" alt="" style="left:0">
						<input type="text" maxlength="5" id="hauteur" placeholder="hauteur" class="dimensions_panneau" />
					</div>
				</div>
			</div>
		</div>
...
<script src="./js/panneaux.js?<?php echo mt_rand(); ?>"></script>
