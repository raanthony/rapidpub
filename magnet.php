...
<link rel="stylesheet" href="./css/magnet.css?<?php echo mt_rand(); ?>" type="text/css" media="all" />
...
<div id="magnets_config">
	<div class="container-left">
		<div id="block_left">
			<div id="text_content">
				<div class="img">
					<img src="http://placehold.it/130x130" alt="Créer un magnet en ligne" title="Produit préféré de nos clients" />
				</div>
				<div class="text">
					<h1>Magnets</h1>
			...
			<div id="apercu_content">
				<div id="magnet_bg">
					<div id="magnet_content">
						<div id="magnet_width"></div><div id="magnet_height"></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div id="config_right">
				<div id="dimensions">
					...
					<div id="longueur_cfg" style="position:relative">
						...
						<input type="text" maxlength="5" id="longueur" placeholder="longueur" class="dimensions_magnet" />
					</div>
					<div id="hauteur_cfg" style="position:relative;margin-left: 10px;">
						<img src="./img/hauteur.png" class="dim_img" alt="" style="left:0">
						<input type="text" maxlength="5" id="hauteur" placeholder="hauteur" class="dimensions_magnet" />
					</div>
				</div>
			</div>
		</div>
...
<script src="./js/magnet.js?<?php echo mt_rand(); ?>"></script>
