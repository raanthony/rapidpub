...
if (isset($_POST['text']) AND $_POST['text'] != '' AND isset($_POST['action']) AND $_POST['action'] == 'update') {
    ...
    $height_text = (!isset($_POST['textHeight'])) ? 0 : floatval($_POST['textHeight']);
     // dimensions text
    
    $width_text = (!isset($_POST['textWidth'])) ? 0 : floatval($_POST['textWidth']);
     // dimensions text
    ...
    if (isset($_POST['id'])) {
        ...
        $_SESSION['rapidpub'][$productID]['text'][$id]['font'] = $textFont;
        
        $_SESSION['rapidpub'][$productID]['text'][$id]['height'] = $h;
        
        $_SESSION['rapidpub'][$productID]['text'][$id]['width'] = $w;
        
        $_SESSION['rapidpub'][$productID]['text'][$id]['ratio'] = floatval($ratio);
        
        $_SESSION['rapidpub'][$productID]['text'][$id]['nombreLettres'] = $length;
        
        $data = $_SESSION['rapidpub'][$productID]['text'][$id];
    } 
    else {
        ...
        $_SESSION['rapidpub'][$productID]['text'][$id] = $data;
    }
