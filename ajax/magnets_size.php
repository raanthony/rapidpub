...
if ( isset( $_POST['action'] ) AND $_POST['action'] == 'getsize' ) {
	...
	switch ($_POST['type']) {
		...
		case 'fond':
		case 'forme':
			$_SESSION['rapidpub'][$_POST['type']][$id]['tarif'] = $tarif;
			$_SESSION['rapidpub'][$_POST['type']][$id]['surface'] = $surface;
			$_SESSION['rapidpub'][$_POST['type']][$id]['motifWidth'] = $newWidth;
			$_SESSION['rapidpub'][$_POST['type']][$id]['motifHeight'] = $newHeight;
		break;
		default:
			die();
		break;
